...
```
$ curl http://localhost:3003/placeholder.txt
...
```
$ curl http://localhost:3003/unauthorized
$ # result -> true
```
...
```
$ curl http://localhost:3003/authorized
...
```
$ # POST /auth/login
$ curl -X POST http://localhost:3003/auth/login -d '{"username": "maria", "password": "123"}' -H "Content-Type: application/json"
...
$ curl http://localhost:3003/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2Vybm..."
$ # result -> {"userId":2}
```
